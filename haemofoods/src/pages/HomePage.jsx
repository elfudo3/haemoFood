  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="text-center pt-16 pb-12 border-b border-stone-200 dark:border-stone-800">
        <h1 className="text-4xl font-bold tracking-tight text-stone-900 mb-6 opacity-0 animate-[fadeInUp_0.8s_ease-out_forwards] dark:text-stone-100">
        ...
        <p className="text-lg text-stone-500 max-w-lg mx-auto mb-8 opacity-0 animate-[fadeInUp_0.6s_ease-out_forwards] [animation-delay:0.3s] dark:text-stone-400">
      ...
      <div className="py-12 border-b border-stone-200 opacity-0 animate-[fadeInUp_0.6s_ease-out_forwards] [animation-delay:0.6s] dark:border-stone-800">
        <p className="font-logo text-sm uppercase tracking-widest text-red-700 mb-2 dark:text-red-400">
          Our Mission
        </p>
        <h2 className="text-2xl font-bold text-stone-900 mb-4 dark:text-stone-100">
      ...
      <div className="py-12 border-b border-stone-200 opacity-0 animate-[fadeInUp_0.6s_ease-out_forwards] [animation-delay:0.8s] dark:border-stone-800">
        <p className="font-logo text-sm uppercase tracking-widest text-red-700 mb-2 dark:text-red-400">
          What is HaemoFood
        </p>
        <h2 className="text-2xl font-bold text-stone-900 mb-4 dark:text-stone-100">
        ...
        <p className="text-stone-600 leading-relaxed mb-4 dark:text-stone-400">
